          ...
          <Elem name="title">
            ...
            >
              <Dropdown.Trigger
                content={
                  <Menu contextual>
                    <Menu.Item href={`/projects/${project.id}/settings`}>{t('common_title_settings')}</Menu.Item>
                    <Menu.Item href={`/projects/${project.id}/data?labeling=1`}>{t('common_button_label')}</Menu.Item>
                  </Menu>
                }
              >
